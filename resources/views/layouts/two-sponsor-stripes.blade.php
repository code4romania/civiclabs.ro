...
<head>
    ...
    <script>
        var defaultDayNames = {!! getTranslatedDayNamesJson() !!},
            defaultMonthNames = {!! getTranslatedMonthNamesJson() !!};
    </script>
</head>
<body>
    <div id="app">
        @include('layouts.header')
        @include('site._placeholders.sitePartners')
        @include('site._placeholders.initiatorStripe')
